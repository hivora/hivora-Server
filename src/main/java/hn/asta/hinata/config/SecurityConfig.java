...
import hn.asta.hinata.auth.TokenService;
import hn.asta.hinata.auth.sso.MongoAuthorizationRequestRepository;
import hn.asta.hinata.auth.sso.SsoLoginSuccessHandler;
...
public class SecurityConfig {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http,
			...
			hn.asta.hinata.auth.sso.SsoLoginFailureHandler ssoFailureHandler,
